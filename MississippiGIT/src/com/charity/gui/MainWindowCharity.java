...
import java.io.*;
	...
	public class MainWindowCharity extends JFrame implements ActionListener
	{
		...
		JPanel desktop;
		JMenuBar menuBar;
		JMenu mFile, mSomething, mShow, mHelp,
					//new menus...
					mEmployee, mClient, mCampaign;  
		...
		private JMenuBar createMenuBar()
		{
			...
			mEmployee.setFont(font);
			mEmployee.setMnemonic(KeyEvent.VK_E);
			mEmployee.addMouseListener(new MouseAdapter()
			{
				public void mouseEntered(MouseEvent me)
				{				
					mEmployee.setBackground(backcolor);
					mEmployee.setForeground(Color.gray);
				}
				public void mouseExited(MouseEvent m)
				{				
					mEmployee.setBackground(emptycolor);
					mEmployee.setForeground(Color.black);
				}
			});
			
			mEmployee.add(mAddEmployee = new JMenuItem("Add new") );
//			mAddEmployee.setMnemonic(KeyEvent.VK_S);
//			mAddEmployee.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK) );
			mAddEmployee.addActionListener(this);
			mAddEmployee.setFont(font);
			
			mEmployee.add(mSearchEmployee = new JMenuItem("Search") );
...
//			mStaffGrades.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK) );
			mStaffGrades.addActionListener(this);
			mStaffGrades.setFont(font);
			
			mEmployee.add(mBonus = new JMenuItem("Bonus") );
//			mBonus.setMnemonic(KeyEvent.VK_S);
//			mBonus.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK) );
			mBonus.addActionListener(this);
			mBonus.setFont(font);
			
			
			
			mClient = new JMenu("Client");
			mClient.setFont(font);
			mClient.setMnemonic(KeyEvent.VK_C);
			mClient.addMouseListener(new MouseAdapter()
			{
				public void mouseEntered(MouseEvent me)
				{				
					mClient.setBackground(backcolor);
					mClient.setForeground(Color.gray);
				}
				public void mouseExited(MouseEvent m)
				{				
					mClient.setBackground(emptycolor);
					mClient.setForeground(Color.black);
				}
			});
			
			mClient.add(mAddClient = new JMenuItem("Add New") );
//			mAddClient.setMnemonic(KeyEvent.VK_S);
//			mAddClient.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK) );
			mAddClient.addActionListener(this);
			mAddClient.setFont(font);
			
			mClient.add(mSearchClient = new JMenuItem("Search") );
//			mSearchClient.setMnemonic(KeyEvent.VK_S);
//			mSearchClient.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK) );
			mSearchClient.addActionListener(this);
			mSearchClient.setFont(font);		
			
			mCampaign = new JMenu("Campaign");
			mCampaign.setFont(font);
			mCampaign.setMnemonic(KeyEvent.VK_A);
			mCampaign.addMouseListener(new MouseAdapter()
			{
				public void mouseEntered(MouseEvent me)
				{				
					mCampaign.setBackground(backcolor);
					mCampaign.setForeground(Color.gray);
				}
				public void mouseExited(MouseEvent m)
				{				
					mCampaign.setBackground(emptycolor);
					mCampaign.setForeground(Color.black);
				}
			});
...
//				calShow.showDailyCalendar(userDate);
	...
	/*    private PersonalCalendar retrieveReminderFromDisk(String filename)
		...
		{
			MainWindowCharity pc = new MainWindowCharity();
			pc.setVisible(true);
